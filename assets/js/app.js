...
function displayMap() {
  ...
  L.tileLayer("https://{s}.tile.jawg.io/jawg-terrain/{z}/{x}/{y}{r}.png?access-token={accessToken}", {
    ...
    maxZoom: 22,
    subdomains: "abcd",
    accessToken: "2zG8ZkDeXRl25x4C8ZtWDvTNYKYF9bg1h4IPq294yprhJni2kRYlfCedSztKZo3s", //My Tokenkey
  }).addTo(map);
}

// Gets data for the route from TOMTOM API's
function getRouteData(startLocation, endLocation) {
  var apiKey = "bPdYnPXV8GXhyGGAqnC8Y9iK6YptHGGY"; //zulfiqarG API
...
var currentURL = baseURL + `weather?appid=cdf99d234b178c14e018047fd5452bd0&units=metric&`;
